...
@section('content')
<div class="container mx-auto sm:px-4 pb-24">
    <div class="flex pt-14 mt-0.5  justify-center">
        <div class="w-1/2 mt-14 pr-4 pl-4">
            <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300">
                ...
                <div class="flex-auto p-6">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-4 flex flex-wrap pl-8 mb-0">
                            <div class="md:w-1/2 pr-4 pl-4 md:mx-1/3">
                                <button type="submit" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 ml-16 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
