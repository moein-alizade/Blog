<nav class="relative flex flex-wrap items-center content-between px-4 text-white bg-green-850 top-0">
    <div class="container mx-auto sm:px-4">
      <div class="flex flex-row-reverse justify-end w-full" id="navbarResponsive">
          <div class="w-3/12 h-1/6">
              <a href="/" class="flex flex-row-reverse"><img src="/image/mlogo2.png" id="mlogo" class="w-1/4"></a>
          </div>

          <div class="w-9/12 h-1/6 pt-5 flex">
          ...
          @else
              <a href="{{ route('login') }}" class="w-1/13 h-1/6 mt-5 bg-green-500 hover:bg-green-600 hover:border-green-600 border-green-500 border border-solid font-normal inline-block no-underline px-3 py-1.5 rounded-lg select-none text-center text-white">login</a>
          @endif
